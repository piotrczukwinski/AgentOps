...
participation in the AgentOps project a welcoming and inclusive
...
pull requests, discussions, and any other official channel — as
well as in any public space when an individual is representing
...
and investigated on a best-effort basis. The maintainer will
keep the reporter's identity confidential when reasonably
possible.

...
* MiniMax / opencode executor repairs are limited to
  ``max_executor_review_repairs`` per task (default preserves
  legacy behaviour; the v1 hardening is the explicit opt-in 1).
...
class ReviewConfigDefaultsTests(unittest.TestCase):
    ...
    def test_max_executor_review_repairs_field_exists(self) -> None:
        ...
        self.assertGreaterEqual(rc.max_executor_review_repairs, 1)

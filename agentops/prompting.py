        ...
        *,
        ...
        return "\n".join(
            [
                ...
                "judgement, make NO file changes and instead print exactly:",
                f"    {SELF_FIX_SKIP_MARKER}: <SELF_FIX_BY_CODEX|LARGE_MECHANICAL_REPAIR|OPERATOR_DECISION_REQUIRED|BLOCK> <short reason>",
                "AgentOps will then fall back to the executor (one attempt only)",
                "or block the task per the repair-routing churn guard.",
